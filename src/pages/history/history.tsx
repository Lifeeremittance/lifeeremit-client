                  ...
                  <td>
                    <div className="d-flex align-items-center">
                      ...
                      <div className="d-flex flex-column">
                        <b>OMEGA business plc</b>
                        <span className="text-small">Sage 200 Evolution</span>
                        <span className="text-small text-success">Success</span>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div className="d-flex align-items-center">
                      <span className="text-muted text-small">12 JUN 2022</span>
                    </div>
                  </td>
                  <td>200 USD</td>
                  <td>
                  ...
                  <td>
                    <div className="d-flex align-items-center">
                      ...
                      <div className="d-flex flex-column">
                        <b>OMEGA business plc</b>
                        <span className="text-small">Sage 200 Evolution</span>
                        <span className="text-small text-theme">Pending</span>
                      </div>
                    </div>
                  </td>
                  <td>
